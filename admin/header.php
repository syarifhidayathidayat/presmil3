...
<head>
  ...
  <title>Administrator - Sistem Informasi Kuesioner Ibu Hamil Online</title>
  ...
  <link rel="stylesheet" href="../assets/css/polkessin.css">
  <?php
  include '../koneksi.php';
  session_start();
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-danger mb-4 shadow">
    <a class="navbar-brand" href="index.php"><b>Presmil.com</b></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link" href="profesi.php"><i class="fa fa-graduation-cap"></i> Data Profesi</a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="master.php"><i class="fa fa-cog"></i> Pertanyan & Jawaban</a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="bumil.php"><i class="fa fa-users"></i> Hasil Kuesioner</a>
        </li>
        <li class="nav-item active">
          <a class="nav-link" href="tampil_saran.php"><i class="fa fa-comments"></i> Saran Responden</a>
        </li>
      </ul>
